...
class percent():
    def imageTrat(self):
        ...
        imagem = cv2.imread(paciente.imagemImport, 1)
        ...
        coresValores = [vermelho, laranja, amarelo, verde, ciano, azul, violeta, magenta, branco, total]

        return coresValores

    def coresPercent(self, coresValores):
        vermelhoPercent = (coresValores[0]/coresValores[9])*100
        laranjaPercent = (coresValores[1]/coresValores[9])*100
        amareloPercent = (coresValores[2]/coresValores[9])*100
        verdePercent = (coresValores[3]/coresValores[9])*100
        cianoPercent = (coresValores[4]/coresValores[9])*100
        azulPercent = (coresValores[5]/coresValores[9])*100
        violetaPercent = (coresValores[6]/coresValores[9])*100
        magentaPercent = (coresValores[7]/coresValores[9])*100
        brancoPercent = (coresValores[8]/coresValores[9])*100

        porcentagensCor = [vermelhoPercent, laranjaPercent, amareloPercent, verdePercent, cianoPercent, azulPercent, violetaPercent, magentaPercent, brancoPercent]
        return porcentagensCor